...
|
*/
$config['base_url'] = 'cconv.craftw.lv';
...
$config['csrf_token_name'] = 'csrf_test_cconv';
$config['csrf_cookie_name'] = 'csrf_cookie_cconv';
...
// currconv.com CONFIG
$config['cc_url'] = 'https://free.currconv.com/api/v7/';
$config['cc_key'] = '37fefe63d104abfb6e07';

$config['csrf_exclude_uris'] = array('ajax/calc');
